				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="grid-container" class="cbp-l-grid-projects">
							<ul>
							<?php
							$result=select("select * from sun_glass");
							while($r=mysqli_fetch_array($result))
							{extract($r);
							?>
								
								<a href="preview.php?id=<?=$sun_glassid?>"><li class="cbp-item graphic">
									<div class="cbp-caption">
										<div>
											<img src="admin/images/Sun Glasses/<?=$image?>" alt="" style="width:250px;height:100px"/>
										</div>
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="admin/images/Sun Glasses/<?=$image?>" class="cbp-lightbox cbp-l-caption-buttonRight" data-title="Dashboard<br>by Paul Flavius Nechita">view larger</a>
												</div>
												<div class="cbp-l-caption-body">
													<a href="preview sun_glass.php?id=<?=$sun_glassid?>" class="cbp-l-caption-buttonRight">Buy Now</a>													
												</div>
											</div>
										</div>
									</div>
