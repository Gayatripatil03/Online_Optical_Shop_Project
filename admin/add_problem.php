                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal" enctype="multipart/form-data" id="commentForm" method="post"  novalidate="novalidate">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">EyeGlass : </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="Pro_name"  type="text" required="">
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">ComputerGlass: </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="Pro_name"  type="text" required="">
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">SunGlass : </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="Pro_name"  type="text" required="">
                                        </div>
                                    </div>
									<div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">progressive : </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="Pro_name"  type="text" required="">
                                        </div>
                                    </div>
...
if(isset($_REQUEST['savecat']))
{
	...
	$n=iud("INSERT INTO `problem`( `name`,'computerglass','sunglass','prograssive' `charge`) VALUES('$Pro_name','$pro_name1','$pro_name2,'$pro_name3',$charge') ");
	if($n==1)
	{
echo "Successful";
	}
