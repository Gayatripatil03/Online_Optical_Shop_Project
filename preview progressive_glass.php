		...
		<section id="content">
			<div class="container">
				<div class="row">
					...
					$result=select("select * from progressive_glass where progressive_glassid='".$_REQUEST['id']."'");
					...
					?>
						...
						<h3><?=ucwords($name)?></h3>
						<img src="admin/images/Progressive Glasses/<?=$image?>" alt="" class="img-responsive" />
