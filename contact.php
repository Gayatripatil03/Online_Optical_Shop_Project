          ...
          <div class="row">
            <div class="col-md-6">
              <ul class="topleft-info">
                <li><i class="fa fa-phone"></i> +91 8329169716</li>
              </ul>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-sm-3 col-lg-3">
            <div class="widget">
              ...
              <address>
                <strong></strong>shop no 2B,<br>
                Krishna Chauk,<br>
				New Sanvi,Pune
                </address>
              <p>
                <i class="icon-phone"></i> 8329169716 / 8623951288 <br>
                <i class="icon-envelope-alt"></i> patilgayatri2203@gmail.com
              </p>
            </div>
          </div>
          <!--<div class="col-sm-3 col-lg-3">
      ...
      <div id="sub-footer">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <div class="copyright">
                <p>&copy; B2 batch- Mr.khatik sir</p>
                <div class="credits">
                  <!--
                  ...
                  -->
                  Designed by <a href="https://bootstrapmade.com/">B2 batch</a>
                </div>
              </div>
            </div>
            <div class="col-lg-6">
