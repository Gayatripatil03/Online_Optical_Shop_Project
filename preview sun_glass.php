		...
		<section id="content">
			<div class="container">
				<div class="row">
					...
					$result=select("select * from sun_glass where sun_glassid='".$_REQUEST['id']."'");
					...
					?>
						...
						<h3><?=ucwords($name)?></h3>
						<img src="admin/images/Sun Glasses/<?=$image?>" alt="" class="img-responsive" />
						...
						<aside class="right-sidebar">
							...
							<div class="widget">
								...
								<ul class="tags">
									...
									<li><a href="#">Total Amount-<?=$price?>/-</a></li></br>
									
									
								</ul><span style="font-weight:bold">Description-</span><p style="text-align:justify"> <?=$description?></p>
								<a  href="payment.php?m=<?=$price?>"><button class="btn btn-success">Payment
								</button>
							</div>
						</aside>
					</div>
