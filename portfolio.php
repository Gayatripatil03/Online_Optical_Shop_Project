										...
										<div class="cbp-caption-activeWrap">
											<div class="cbp-l-caption-alignCenter">
												<div class="cbp-l-caption-body">
													<a href="admin/images/<?=$image?>" class="cbp-lightbox cbp-l-caption-buttonRight" data-title=" ">View Larger</a>													
												</div>
												<div class="cbp-l-caption-body">
													<a href="preview.php?id=<?=$glassid?>" class="cbp-l-caption-buttonRight">Buy Now</a>													
												</div>
											</div>
										</div>
									</div>
