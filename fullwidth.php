					...
					<div class="row">
						<div class="col-md-6">
							<ul class="topleft-info">
								<li><i class="fa fa-phone"></i> +91 7745803523 / 8329169716
							</ul>
						</div>
						<div class="col-md-6">
				...
				<div class="row">
					...
					<strong>Sailor company Inc</strong><br>
					 ...
					 Someplace 71745 Earth </address>
							<p>
								<i class="icon-phone"></i> +91 7040072721 <br>
								<i class="icon-envelope-alt"></i> aadityagadekar007@gmail.com
							</p>
						</div>
					</div>
					<div class="col-lg-3">
